<template>
  <v-form cols="1" md="3" ref="form" lazy-validation>
    ...
    <v-checkbox
        v-model="dataForm.checkboxOutletSalesOnly"
        :label="`Outlet Sales Only`" >
      </v-checkbox>

      <v-checkbox
        v-model="dataForm.checkboxQtyIncAllInclusive"
        :label="`Quantity Include All Inclusive`" >
      </v-checkbox>
  ...
  data() {
    return {
      ...
      dataForm: {
        ...
        toDepartment: null,
        category: 4,
        checkboxOutletSalesOnly: false,
        checkboxQtyIncAllInclusive: false,
      }
    };
  },
  methods: {
