...
import MinStockOnHand from "../app/inventory/reports/min-stock-on-hand.vue";
import MaxStockOnHand from "../app/inventory/reports/max-stock-on-hand.vue";
...
import MonthlyIncoming from "../app/inventory/reports/monthly-incoming.vue";
import PriceDiscrepancy from "../app/inventory/reports/price-discrepancy.vue";
import IncomingReturn from "../app/inventory/reports/incoming-return.vue";
...
const routes = [
  ...
  {
    path: "/monthly-incoming",
    name: "Monthly Incoming",
    component: MonthlyIncoming
  },
  {
    path: "/price-discrepancy",
    name: "Price Discrepancy",
    component: PriceDiscrepancy
  },
  {
