<template>
  <div id="app">
    <q-drawer :value="true" side="left" bordered :width="220" persistent>
      <SearchIssuing :searches="searches" :dialogTransfer="dialogTransfer" @onSearch="onSearch" />
    </q-drawer>
...
import { tableHeaders, dataDummy } from './tables/Issuing.table';
...
export default defineComponent({
  ...
  components: {
    SearchIssuing: () => import('./components/SearchIssuing.vue'),
  },
});
</script>
