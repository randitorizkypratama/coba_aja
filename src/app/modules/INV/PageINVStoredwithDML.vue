        ...
        <div class="q-pa-lg">
          <div class="row">
            <div style="marginRight: 10px" class="col">
              <SSelect label-text="Outlet" :options="searches.departments" v-model="fromDept" />
              <SSelect
                style=" marginTop: -5px"
                label-text="Stored"
            ...
            <div style=" marginLeft: 10px" class="col">
              <SSelect label-text="Suplier" :options="searches.departments" v-model="fromDept" />
              <SInput
          ...
          <div>
            ...
            <div class="row">
              ...
              <q-btn
                ...
                label="Receive"
                type="submit"
                style="width: 320px; height: 25px; marginTop: 20px; marginRight: 20px"
                @click="onSearch"
              />
