    ...
    <v-row>
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/FO-Cashier.svg')"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/TO.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/HK.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/SM.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/POS.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/Banquet.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/Outlet.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/AR.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/Purchasing.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/AP.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/GC.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/GL.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/FixAssets.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/Engineering.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/SettingTools.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/Setting.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
      ...
      <v-col cols="6" md="2">
        <v-card class="pa-2" max-width="160" hover outlined>
          <v-img
            max-width="80"
            :src="require('../assets/main-screen/IncomeAudit.svg')"
            class="mb-3 ml-auto mr-auto"
            width="80"
            contain
            height="60"
          />
          <p class="text-no-wrap mx-auto">Income Audit</p>
        </v-card>
      </v-col>
    </v-row>
  </v-container>
